...
// 有个很重要的点 OderHeadListener 不能被spring管理，要每次读取excel都要new,然后里面用到spring可以构造方法传进去
public class OrderHeadListener extends AnalysisEventListener<OrderHead> {
    private static final Logger LOGGER = LoggerFactory.getLogger(OrderHeadListener.class);
    /**
     ...
     */
    @Override
    public void invoke(OrderHead data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        orderHeadMapper.batchInsertOrderHead(list);
        LOGGER.info("存储数据库成功！");
    }
}
